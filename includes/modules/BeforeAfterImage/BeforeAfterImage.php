...
/**
 * All-in-One Before After Image
 */
class AIOBAI_BeforeAfterImage extends ET_Builder_Module {

    public $slug       = 'aiobai_before_after_image';
